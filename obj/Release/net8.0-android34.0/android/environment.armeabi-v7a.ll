...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 166363270, ; hash 0x9ea8086, from name: MyTest
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1224874958, ; hash 0x49021bce, from name: libaot-MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 125
	...
	%struct.DSOCacheEntry {
		i64 1868738037, ; hash 0x6f62adf5, from name: aot-MyTest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 197
	...
	%struct.DSOCacheEntry {
		i64 1964953120, ; hash 0x751ece20, from name: libaot-MyTest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 211
	...
	%struct.DSOCacheEntry {
		i64 3012017928, ; hash 0xb387bf08, from name: aot-MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 345
	...
	%struct.DSOCacheEntry {
		i64 3372434725, ; hash 0xc9034525, from name: MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 385
