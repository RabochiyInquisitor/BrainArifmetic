...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 59034391685363978, ; hash 0xd1bb7769eff90a, from name: aot-MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6109273498891507375, ; hash 0x54c87fe10122d6af, from name: MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	...
	%struct.DSOCacheEntry {
		i64 6934908814138693506, ; hash 0x603dbed2e0765782, from name: libaot-MyTest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 7123295554170646978, ; hash 0x62db0790d075f1c2, from name: MyTest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 11743178137203213454, ; hash 0xa2f8264c3a21848e, from name: aot-MyTest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 299
	...
	%struct.DSOCacheEntry {
		i64 15658090160919173850, ; hash 0xd94cb60a8ea05ada, from name: libaot-MyTest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyTest.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
...
@.env.3 = private unnamed_addr constant [37 x i8] c"1c0ae33f-443f-4643-8c1b-78e0a7f7c9aa\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.mytest\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-MyTest.dll.so\00", align 16
